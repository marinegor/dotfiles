...
rm -rf /tmp/marinegor-dotfiles && mkdir -p /tmp/marinegor-dotfiles && cd /tmp/marinegor-dotfiles && git clone https://github.com/marinegor/dotfiles.git --recursive && cd dotfiles
